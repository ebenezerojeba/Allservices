          ...
          <div className="flex-1 p-8 sm:p-10 lg:p-16 z-10">
            <div className="space-y-6">
              ...
              <div className="flex flex-col sm:flex-row gap-4 pt-4">
                ...
                <button className="inline-flex items-center justify-center px-8 py-3.5 bg-blue-50/20 text-white font-semibold rounded-tl-full hover:bg-blue-500/30 transition-all duration-200">
