...
const TopDoctors = () => {
  ...
  return (
    ...
    <h1 className=' text-2xl text-blue-800 text-center font-bold'>Top Skilled-Workers to Book</h1>
    <p className='sm:w-1/3 text-center text-sm'>Simply browse through our extended list of trusted skilled-workers</p>
   ...
   {doctors.slice(3,7).map((item,index)=>(
    ...
    <button onClick={()=>{navigate('/doctors'); scrollTo(0,0)}} className='bg-blue-50'>more</button>
</div>
  )
}
